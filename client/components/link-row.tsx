  ...
  return (
    <div className="flex items-start justify-between py-1 gap-4">
      ...
      >
        ...
        <strong className="break-word font-medium text-gray-900 group-hover:text-primary dark:text-gray-100 sm:break-normal">
          {title}
        </strong>
      </a>
      <div className="flex items-center gap-3 flex-shrink-0">
        <button
          ...
          className="hidden sm:block text-xs text-gray-500 hover:text-primary dark:text-gray-400"
        >
          {baseDomain}
        </button>
        <p className="font-berkeley text-gray-500 text-sm whitespace-nowrap dark:text-gray-400">
          {formatDate(created)}
        </p>
      </div>
    </div>
