...
export function Entries({ database }) {
  ...
  const handleShuffleClick = () => {
    if (filteredEntries.length > 0) {
      ...
      window.location.href = randomEntry.url.replace("pdf", "abs");
    }
  };
    ...
    <div className="max-h-screen w-full flex-col overflow-y-scroll px-4 sm:px-8">
      <div className="mx-auto w-full max-w-5xl mt-4 mb-52 md:mb-32">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 text-gray-600 p-2 border border-gray-400 rounded-md mb-4 ml-2 float-right bg-[#f0eadd] hover:bg-indigo-100"
        >
          Shuffle
